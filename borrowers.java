...
{  
	...
	{  
		...
		//Labels
		Label l1,l2,l3,l4;  
    		l1=new Label("Borrower's Id");  
   		    l1.setBounds(50,100, 100,30); 
 
    		l2=new Label("Date of issue");  
    		l2.setBounds(50,150, 100,30);  

    		l3=new Label("Date of return");  
   		    l3.setBounds(50,200, 100,30); 
 

    		l4=new Label("BORROWERS");  
		...
		Button b1, b2 , b3 ,b4;
		b1=new Button("Save");  
		b1.setBounds(50,250,60,40); 
	
		b2=new Button("Modify");  
		b2.setBounds(120,250,60,40);

		b3=new Button("Delete");  
		b3.setBounds(190,250,60,40); 
	
		b4=new Button("Cancel");  
		b4.setBounds(260,250,60,40); 
